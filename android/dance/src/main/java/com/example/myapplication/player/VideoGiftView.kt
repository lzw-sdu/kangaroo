...
import com.sdu.kangaroo.alpha_player.controller.IPlayerController
import com.sdu.kangaroo.alpha_player.controller.PlayerController
...
class VideoGiftView @JvmOverloads constructor(
    ...
    fun startVideoGift(filePath: String) {
        ...
        val dataSource = DataSource()
            .setBaseDir(filePath)
            .setPortraitPath(
                configModel.portraitItem!!.path!!,
                configModel.portraitItem!!.alignMode
            )
            .setLandscapePath(
                configModel.landscapeItem!!.path!!,
                configModel.landscapeItem!!.alignMode
            )
            .setLooping(false)
