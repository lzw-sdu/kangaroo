...
import static com.sdu.kangaroo.screenrecorder.ScreenRecorder.VIDEO_AVC;
    ...
    static class ScreenRecorderService implements IScreenRecorderService {
        ...
        void prepareScreenRecorder() {
            ...
            if (hasPermissions()) {
                ...
                mScreenRecorder = newRecorder(mMediaProjection, mVideoEncodeConfig, mAudioEncodeConfig, file.getAbsolutePath());
            } else {
        ...
        ScreenRecorder newRecorder(MediaProjection mediaProjection, VideoEncodeConfig video,
                                   AudioEncodeConfig audio, String outputPath) {
            final VirtualDisplay display = getOrCreateVirtualDisplay(mediaProjection, video);
            ScreenRecorder r = new ScreenRecorder(video, audio, display, outputPath);
