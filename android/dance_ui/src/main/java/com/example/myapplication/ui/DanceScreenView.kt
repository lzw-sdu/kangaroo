        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Box(
                ...
                Column(
                    ...
                    TopItem(title = "血氧", value = "${danceScreenState!!.bloodOxygen}%")
                    Spacer(modifier = Modifier.height(20.dp))
                    TopItem(title = "心率", value = "${danceScreenState!!.bloodOxygen}%")
                    Spacer(modifier = Modifier.height(20.dp))
                    TopItem(title = "卡路里", value = "${danceScreenState!!.bloodOxygen}kcal")
                }
            }
